...
const DashboardHeader: FC<Props> = () => {
  ...
  return (
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0">
      ...
      >
        <MdNotificationsNone className="text-2xl cursor-pointer dark:text-white text-black" />
      ...
      {open && (
        <div className="w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 right-0 z-10 rounded">
