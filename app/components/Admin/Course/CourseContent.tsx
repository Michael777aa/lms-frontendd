...
const CourseContent: FC<Props> = ({
  ...
  const addNewSection = () => {
    if (courseContentData.length === 0) {
      toast.error("Please add at least one content section first!");
      return;
    }
  ...
  return (
    <div className="w-[80%] m-auto mt-24 p-3">
      <form onSubmit={handleSubmit}>
        ...
        <div
          className="flex items-center text-[20px] cursor-pointer dark:text-white text-black"
